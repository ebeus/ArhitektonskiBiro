...
<html>
    ...
    <body>
      ...
      <div class="wrap_main">
        ...
        <div class="pitanje_form">
        <form action="spremi_pitanje.php" method="post" id="pitanje_forma" name="kontakt_forma" onsubmit="return validateContactForm()">
            <table>
                <tr>
                    <td>Ime:</td>
                ...
                <tr>
                    <td>Pitanje:</td>
                    <td><textarea maxlength=1000 cols="50" rows="5" name="tekst" id="pitanje"  form="pitanje_forma"></textarea></td>
                </tr>
